      ...
      <Dialog {...args} open={isOpen} onClose={() => setIsOpen(false)}>
        <div style={{ width: '30rem' }}>
          ...
          <Typography>
            ...
            imperdiet sapien wisi sed libero. Maecenas fermentum, sem in
            pharetra pellentesque, velit turpis volutpat ante, in pharetra metus
            odio a lectus. Fusce nibh. Integer lacinia. Donec quis nibh at felis
            congue commodo. Nullam lectus justo, vulputate eget mollis sed,
            tempor sed magna.
          </Typography>
