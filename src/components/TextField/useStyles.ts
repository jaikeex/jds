    ...
    mergeOverrides(
      {
        ...
        filled: (props: TextFieldProps) => ({
          ...
          borderBottom: {
            width: '1px',
            style: 'solid',
            color: theme.palette.rgba(theme.palette[props.color || 'primary'].light, 0.6)
          },
          '&:hover': {
            borderColor: theme.palette[props.color || 'primary'].main,
            backgroundColor: theme.palette.rgba(theme.palette[props.color || 'primary'].light, 0.15)
          },
          '&:focus-within': {
            borderColor: theme.palette[props.color || 'primary'].main,
            boxShadow: {
        ...
        outlined: (props: TextFieldProps) => ({
          border: {
            width: '1px',
            style: 'solid',
            color: theme.palette.rgba(theme.palette[props.color || 'primary'].main, 0.6)
          },
          '&:hover': {
            borderColor: theme.palette[props.color || 'primary'].main
          },
